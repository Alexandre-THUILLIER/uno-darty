$(document).ready(function() {
    ...
    $('.play').click(function(e) {
        ...
        if ( players.length > 0 ) {
            ...
            for ( e = 0; e < players.length; e++) {
                ...
                $('#begin-play > .content').append('<div class="user" data-user="'+ players[e].id +'" data-score="0" data-name="'+ players[e].name +'"><div class="win"><i class="icon-crown"></i></div><div class="name">'+ players[e].name +'<span class="winner"></span></div><div class="points"><input type="tel" /><span>'+ players[e].totalScore +'</span> pts</div><div class="historique"></div></div>');
            }
    ...
    $(document).on('click', '#btn_add_new_playeur', function() {
        ...
        $('#begin-play > .content').append('<div class="user" data-user="'+ idUserAuto +'" data-score="0" data-name="'+ name +'"><div class="win"><i class="icon-crown"></i></div><div class="name">'+ name +'<span class="winner"></span></div><div class="points"><input type="tel" /><span>'+ highestScore +'</span> pts</div><div class="historique">' + highestScore.toString() + '</div></div>');
